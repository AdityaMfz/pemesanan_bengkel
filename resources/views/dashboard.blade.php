...
<html lang="en">
  <head>
    ...
    <style>
      .product-device  {
    background-image: url('{{ asset('dashmin-1.0.0/img/jimi.jpg') }}');
  ...
  .product-device-2 {
    background-image: url('{{ asset('dashmin-1.0.0/img/adit.jpg') }}');
    background-size: cover;
    background-position: center;
    background-repeat: no-repeat;
    position: absolute;
          ...
          <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
              ...
              <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                ...
                <li>
                  <a href="{{ route('userbarang') }}" class="nav-link text-white">
    ...
    <main>
      <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light" ; >
        <div class="col-md-5 p-lg-5 mx-auto my-5">
          <h1 class="display-4 fw-normal fst-italic">Dit Garage</h1>
          <p class="lead fw-normal " >"Driving Excellence with Every Turn. Trusted Repairs and Unmatched Reliability Since 1998."</p>
      ...
      <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
        <div class="bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
          <div class="my-3 py-3">
            <h2 class="display-5 fst-italic">We Service</h2>
            <p class="lead">"Comprehensive Care for Your Vehicles. From Engine Diagnostics to Tire Services, We've Got You Covered"</p>
          </div>
          <div class="bg-light shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0; background-image: url('{{ asset('dashmin-1.0.0/img/brody.jpg') }}'); background-size: cover; background-position: center;"></div>
        </div>
        <div class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
          <div class="my-3 p-3">
            <h2 class="display-5 fst-italic">Product</h2>
            <p class="lead">"Your Trusted Partner for Auto Care and Quality Spare Parts, Keeping Your Vehicle Running Smoothly"</p>
          </div>
          <div class="bg-dark shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0; background-image: url('{{ asset('dashmin-1.0.0/img/motor.jpg') }}'); background-size: cover; background-position: center;"></div>
        </div>
      </div>
