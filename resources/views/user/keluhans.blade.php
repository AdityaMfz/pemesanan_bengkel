        ...
        <div class="container">
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
              ...
              <li>
                <a href="{{ route('userkeluhan') }}" class="nav-link text-secondary">
            ...
            @foreach ($keluhan as $index => $kh)
                <div class="col-md-4 mb-4">
                    <div class="card glass-card">
                        <div class="card-body">
                            <h5 class="card-title">{{ $kh->nama_keluhan }}</h5>
                            <p class="card-text">
                                <strong>Ongkos:</strong> Rp{{ number_format($kh->ongkos, 0, ',', '.') }}<br>
                                <strong>No Polisi:</strong> {{ $kh->kendaraan->no_polisi }}<br>
                                <strong>Nama Customer:</strong> {{ $kh->customer->nama_customer }}<br>
                                <strong>Nama Pegawai:</strong> {{ $kh->pegawai->nama_pegawai }}
                            </p>
                        </div>
                    </div>
                </div>
