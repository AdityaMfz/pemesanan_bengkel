  ...
  <head>
    ...
    <style>
      ...
      body {
        ...
        background-image: url('{{ asset('dashmin-1.0.0/img/redtor.jpg') }}');
        ...
        <div class="container">
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
              ...
              <li>
                <a href="{{ route('userkendaraan') }}" class="nav-link text-secondary">
            ...
            @foreach ($kendaraan as $index => $k)
                <div class="col-md-4 mb-4">
                    <div class="card glass-card">
                        <div class="card-body">
                            <h5 class="card-title">{{ $k->no_polisi }}</h5>
                            <p class="card-text">
                                <strong>No Mesin:</strong> {{ $k->no_mesin }}<br>
                                <strong>Merek:</strong> {{ $k->merek == 'Lain' ? $k->lain_merek : $k->merek }}<br>
                                <strong>Warna:</strong> {{ $k->warna == 'Lain' ? $k->lain_warna : $k->warna }}
                            </p>
                        </div>
                    </div>
                </div>
