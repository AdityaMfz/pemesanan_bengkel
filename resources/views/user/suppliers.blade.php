...
<html lang="en">
  <head>
    ...
    <style>
      ...
      body {
        background-image: url('{{ asset('dashmin-1.0.0/img/bricks.jpg') }}');
  ...
  <body >
        ...
        <div class="container">
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
              ...
              <li>
                <a href="{{ route('usersupplier') }}" class="nav-link text-secondary">
    ...
    <main>
      <div class="container">
        ...
        <div class="glass-effect mb-4 p-3">
            <h5>Supplier #{{ ($supplier->currentPage() - 1) * $supplier->perPage() + $loop->index + 1 }}</h5>
            <p><strong>Nama Supplier:</strong> {{ $s->nama_supplier }}</p>
            <p><strong>Alamat:</strong> {{ $s->alamat }}</p>
            <p><strong>No HP:</strong> {{ $s->no_hp }}</p>
            <p><strong>Nama Barang:</strong> {{ $s->barang->nama_barang }}</p>
        </div>
        @endforeach
